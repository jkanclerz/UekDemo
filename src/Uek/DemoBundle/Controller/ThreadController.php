...
use Uek\DemoBundle\Entity\Thread;
use Uek\DemoBundle\Form\ThreadType;
...
class ThreadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UekDemoBundle:Thread')->findAll();

        return $this->render('UekDemoBundle:Thread:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UekDemoBundle:Thread:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UekDemoBundle:Thread')->find($id);
        ...
        return $this->render('UekDemoBundle:Thread:show.html.twig', array(
            'entity'      => $entity,
	...
	public function showBySlugAction($slug)
    {
        ...
        $entity = $em->getRepository('UekDemoBundle:Thread')->findOneBySlug($slug);
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UekDemoBundle:Thread:edit.html.twig', array(
            'entity'      => $entity,
